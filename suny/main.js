...
$(document).ready( function(){
	...
	$(window).load(function(){
        ...
        $(".bg_darker").addClass("darker_animate");
        $(".bg_canvas").addClass("canvas_animate");
        $(".logo").addClass("logo_animate");
        $("hgroup").addClass("hgroup_animate");
        $(".my_link").addClass("link_animate");
        $(".footer").addClass("footer_animate");
